...
const dict = {
  ...
  badgeRequestedByUsers: {
    en: "Requested by users",
    no: "Forespurt av brukere",
    de: "Von Nutzern angefragt",
    es: "Solicitado por usuarios",
  },
  badgeUnderReview: {
    en: "Under review",
    no: "Under vurdering",
  ...
  comingSoonNoModelYet: {
    en: "Model to be confirmed",
    no: "Modell avklares",
    de: "Modell wird festgelegt",
    es: "Modelo por confirmar",
  },
  comingSoonVoteTotal: {
    en: "{n} user requests",
    no: "{n} brukerforespørsler",
    de: "{n} Nutzeranfragen",
    es: "{n} solicitudes de usuarios",
  },
  comingSoonVoteTotalOne: {
    en: "1 user request",
    no: "1 brukerforespørsel",
    de: "1 Nutzeranfrage",
    es: "1 solicitud de usuario",
  },
  ...
  repairSteps: {
    en: "Repair Steps & Checklist",
    no: "Reparasjonssteg & Sjekkliste",
    de: "Reparaturschritte & Checkliste",
    es: "Pasos de reparación & Lista de verificación",
  },
  repairStepsHint: {
    en: "Click steps to track your progress.",
    no: "Klikk på steg for å spore fremgangen.",
    de: "Klicken Sie auf Schritte, um Ihren Fortschritt zu verfolgen.",
    es: "Haga clic en los pasos para seguir su progreso.",
  },
